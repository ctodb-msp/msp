...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            cm.createCache(cn.ctodb.msp.domain.User.class.getName(), jcacheConfiguration);
            cm.createCache(cn.ctodb.msp.domain.Authority.class.getName(), jcacheConfiguration);
