...
currentAccount: any;
    ...
    transition() {
        this.router.navigate(['/app-group'], {queryParams:
            {
                page: this.page,
                size: this.itemsPerPage,
    ...
    trackId(index: number, item: AppGroup) {
        return item.id;
    }
    registerChangeInAppGroups() {
        this.eventSubscriber = this.eventManager.subscribe('appGroupListModification', (response) => this.loadAll());
    }
